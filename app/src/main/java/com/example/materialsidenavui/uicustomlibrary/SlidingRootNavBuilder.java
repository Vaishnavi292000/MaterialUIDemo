package com.example.materialsidenavui.uicustomlibrary;
...
import com.example.materialsidenavui.uicustomlibrary.callback.DragListener;
import com.example.materialsidenavui.uicustomlibrary.callback.DragStateListener;
import com.example.materialsidenavui.uicustomlibrary.transform.CompositeTransformation;
import com.example.materialsidenavui.uicustomlibrary.transform.ElevationTransformation;
import com.example.materialsidenavui.uicustomlibrary.transform.RootTransformation;
import com.example.materialsidenavui.uicustomlibrary.transform.ScaleTransformation;
import com.example.materialsidenavui.uicustomlibrary.transform.YTranslationTransformation;
import com.example.materialsidenavui.uicustomlibrary.util.ActionBarToggleAdapter;
import com.example.materialsidenavui.uicustomlibrary.util.DrawerListenerAdapter;
import com.example.materialsidenavui.uicustomlibrary.util.HiddenMenuClickConsumer;
...
public class SlidingRootNavBuilder {
    ...
    private static final float DEFAULT_END_SCALE = 0.55f;
    private static final int DEFAULT_END_ELEVATION_DP = 8;
    private static final int DEFAULT_DRAG_DIST_DP = 140;
